    ...
    def estimate_paf(peaks, heat_mat, paf_mat):
        ...
        for human_id in range(pafprocess.get_num_humans()):
            ...
            for part_idx in range(18):
                ...
                #print human.body_parts[part_idx]
                all_scores.append(pafprocess.get_part_score(c_idx))
                ids.append(part_idx)
                #append a dictionary with all the elements
                #all_scores(zip(part_idx,pafprocess.get_part_score(c_idx)))
            ...
            if is_added:
                ...
                humans.append(human)
        #print(len(part_idx))
        #print (for i in range(part_idx))
        #score_dict(zip((range(len(part_idx))), all_scores)))
        #print (len(ids))
        score_dict = dict(zip(ids, all_scores))
        #print (score_dict)
        return humans, score_dict
