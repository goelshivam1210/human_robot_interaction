...
#modified to train DQN on a new environment with a new reward function
#modifier: Shivam Goel
#email: shivam.goel@wsu.edu
#This file is modified to run a DQN on a turtlebot in a smart home environment with the aim of locating human
'''
import gym
import gym_gazebo
import time
...
if __name__ == '__main__':
    ...
    #env = gym.make('GazeboHumanSmartHomeTurtlebotLidarNn-v0')
    ...
    weights_path = '/tmp/turtle_h2_dqn_ep200.h5' 
    monitor_path = '/tmp/turtle_h2_dqn_ep200'
    params_json  = '/tmp/turtle_h2_dqn_ep200.json'
