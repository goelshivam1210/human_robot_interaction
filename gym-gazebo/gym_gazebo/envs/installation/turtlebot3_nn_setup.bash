...
if [ -z "$GYM_GAZEBO_WORLD_SMART_HOME" ]; then
  bash -c 'echo "export GYM_GAZEBO_WORLD_SMART_HOME="`pwd`/../assets/worlds/human_in_home.world >> ~/.bashrc'
else
  bash -c 'sed "s,GYM_GAZEBO_WORLD_SMART_HOME=[^;]*,'GYM_GAZEBO_WORLD_SMART_HOME=`pwd`/../assets/worlds/round.world'," -i ~/.bashrc'
fi
