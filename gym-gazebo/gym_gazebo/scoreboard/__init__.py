...
add_task(
    id='GazeboHumanSmartHomeTurtlebotLidarNn-v0',
    group='gazebo',
    summary='human finding while obstacle avoidance with a turtlebot in a home'
)

add_task(
    id='GazeboHumanSmartHomeTurtlebotLidarCameraNn-v0',
    group='gazebo'
    summary='human finding and obstacle avoidance in a house, with camera and lidar'
)
